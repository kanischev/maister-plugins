...
- **Skills.** Drive the work with the vendored BMad skills under
  `.claude/skills/`: primarily `bmad-product-brief`, plus `bmad-prfaq`,
  `bmad-deep-recon`, and the `bmad-document-project` compatibility shim. Inside
  any skill, IGNORE the "On Activation / greet /
